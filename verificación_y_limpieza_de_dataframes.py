# -*- coding: utf-8 -*-
"""Verificación y Limpieza de DataFrames.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Qtihsv8TOczMoONd85dOtlfrVJZFeqOK
"""
...
'''
Ejercicio 2 – Eliminación de filas incompletas: 1. Crear una copia del DataFrame. 2. Eliminar filas
con cualquier valor nulo usando dropna(). 3. Comparar el número de filas antes y después. 4.
...
'''
Ejercicio 3 – Relleno con la media o mediana: 1. Rellenar los nulos de Edad con la media. 2.
Rellenar los nulos de Ingreso_Mensual con la mediana. 3. Verificar que ya no queden nulos. 4.
...
'''
Ejercicio 4 – Relleno condicional por grupo: 1. Agrupar por Ciudad. 2. Rellenar los nulos de
Satisfaccion con la media por ciudad usando transform y fillna. 3. Verificar los nulos restantes y
graficar un countplot de Satisfaccion por ciudad.
'''
...
# Guardar el DataFrame como archivo Excel y como archivo CSV
